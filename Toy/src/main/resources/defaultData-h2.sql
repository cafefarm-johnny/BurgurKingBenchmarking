...
insert into foodimgfile (imgfilename, orgfilename, fooditem_fid) values ('더블비프불고기.png', 'double_biff.png', 1)
insert into foodimgfile (imgfilename, orgfilename, fooditem_fid) values ('치즈와퍼.png', 'cheese.png', 2)
insert into foodimgfile (imgfilename, orgfilename, fooditem_fid) values ('몬스터와퍼.png', 'monster.png', 3)
insert into foodimgfile (imgfilename, orgfilename, fooditem_fid) values ('트러플머쉬룸와퍼주니어.png', 'triple.png', 4)